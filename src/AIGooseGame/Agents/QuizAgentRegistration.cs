...
public static class QuizAgentRegistration
{
    ...
    public static IHostedAgentBuilder Register(WebApplicationBuilder builder)
    {
        return builder.AddAIAgent(
            ...
            6. Se la risposta è CORRETTA → chiama ApplyBonusToPlayer con bonus +3 e annuncia "🎉 ESATTO! +3 caselle bonus!"
            7. Se la risposta è SBAGLIATA → chiama ApplyBonusToPlayer con bonus -1 e annuncia "😅 Risposta sbagliata! -1 casella. La risposta corretta era [X]: [spiegazione]."
