        ...
        string deploymentName)
    {
        var gameMaster = builder.AddAIAgent(
            ...
            3. Fai l'handoff all'agente corretto in base alla casella:
               - casella 'dog' (1,13,19) → dog-agent 🐶
               - casella 'joke' (2,8) → joke-agent 😂
               ...
               - casella 'quiz' (7,14) → quiz-agent 📚 (quiz .NET da Microsoft Learn via MCP!)
        ...
        // AzureOpenAIClient viene risolto da DI (registrato da Aspire).
